...
3. **Prefiltro tecnico**: `engine/technical.py` calcula SMA50/200, RSI14, MACD,
   ...
   y se preselecciona a los ~45 mejores candidatos tecnicos (analizar
   fundamentales de las 550 acciones seria demasiado lento).
...
6. **Precio objetivo (3 meses)**: mezcla una extrapolacion amortiguada del
   momentum reciente con una fraccion prudente (35%) del precio objetivo medio
   de analistas (que normalmente tiene horizonte de 12 meses), limitada a un
   rango de -10% / +25% para evitar proyecciones poco realistas.
7. **Stop loss**: el mayor entre `precio - 2×ATR14` y el minimo de las ultimas
   20 sesiones, acotado a una perdida de entre el 4% y el 15%.
8. Se devuelven las 10 acciones con mayor score combinado.
